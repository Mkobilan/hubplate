...
export default function AddOnsPage() {
    ...
    const fetchMenuAndAddOns = async () => {
        ...
        try {
            ...
            // Fetch add-ons and their flexible assignments
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 mt-1">
                            Manage extras and prices mapped to categories or items
                        </p>
                    </div>
                </div>
                <button
            ...
            {loading ? (
                    ...
                    {addOns.map((ao) => (
                        <div key={ao.id} className="card group relative">
                            ...
                            <div className="space-y-4 pt-4 border-t border-slate-800">
                                ...
                                {ao.assigned_items.length > 0 && (
                                    <div className="space-y-2">
                                        <p className="text-xs font-bold text-slate-500 uppercase tracking-wider">
                                            Items:
                                        </p>
                                        <div className="flex flex-wrap gap-2">
                                            {ao.assigned_items.map((itemId) => {
                                ...
                                {ao.assigned_categories.length === 0 && ao.assigned_items.length === 0 && (
                ...
                <div className="card py-20 text-center">
                    ...
                    <p className="text-slate-400 mt-2 max-w-sm mx-auto">
                        Create add-ons like "Extra Cheese" or "Add Avocado" and map them to categories or items.
                    </p>
                    <button
                        onClick={() => setShowAddModal(true)}
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (addOnId) {
                ...
                await (supabase.from("add_on_assignments") as any)
                    .delete()
            ...
            if (assignments.length > 0 && addOnId) {
                const { error } = await (supabase.from("add_on_assignments") as any).insert(
                    assignments
                );
                if (error) throw error;
            }
